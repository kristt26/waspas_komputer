...
<head>
   ...
   <link rel="stylesheet" href="https://netdna.bootstrapcdn.com/font-awesome/4.0.3/<?= base_url() ?>home/css/font-awesome.css">
               ...
               <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                  <div class="full">
                     <div class="center-desk">
                        <div class="logo">
                           <a href="index.html"><img src="<?= base_url() ?>home/images/logo2.png" width="40%" alt="#" /></a>
                        </div>
                     </div>
                  </div>
               </div>
               ...
               <div class="container">
                  <div class="carousel-caption">
                     <div class="row">
                        <div class="col-md-6">
                           <div class="text-bg">
                              <span>Master Computer</span>
                              <p>Membantu permasalahan perkerjaan anda yang membutuhkan perangkat seperti laptop Accessories komputer </p>
                              <!-- <a href="#">Buy Now </a> <a href="contact.html">Contact </a> -->
                           </div>
                        </div>
                        <div class="col-md-6">
                           <div class="text_img">
                              <figure><img src="<?= base_url() ?>home/images/pct.png" alt="#" /></figure>
                           </div>
                        </div>
                     </div>
                  </div>
   ...
   <div class="three_box">
      <div class="container">
         <div class="row">
            <div class="col-md-4">
               <div class="box_text">
                  <i><img src="<?= base_url() ?>home/images/thr.png" alt="#" /></i>
                  <h3>Computer</h3>
                  <p>Kami menyediakan berbagai jenis Perangkat komputer untuk kebutuhan anda </p>
               </div>
            </div>
            <div class="col-md-4">
               <div class="box_text">
                  <i><img src="<?= base_url() ?>home/images/thr1.png" alt="#" /></i>
                  <h3>Laptop</h3>
                  <p>Untuk membantu pekerjaan anda kami, menyediakan berbagai jenis Laptop </p>
               </div>
            </div>
            <div class="col-md-4">
               <div class="box_text">
                  <i><img src="<?= base_url() ?>home/images/thr2.png" alt="#" /></i>
                  <h3>Accessories</h3>
                  <p>Untuk melengkapi perangkat anda, kami menyediakan berbagai jenis Accessories </p>
               </div>
            </div>
         </div>
      </div>
            ...
            <div class="row">
               ...
               <div class="col-md-6">
                  <div class="laptop_box">
                     <figure><img src="<?= base_url() ?>home/images/pc.png" alt="#"/></figure>
                  </div>
               </div>
            </div>
         </div>
                              ...
                              <div class="carousel-caption ">
                                 <div class="row">
                                    <div class="col-md-9 offset-md-3">
                                       <div class="test_box">
                                          <i><img src="<?= base_url() ?>home/images/cos.png" alt="#"/></i>
                                          <h4>Sandy Miller</h4>
