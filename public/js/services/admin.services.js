angular.module('admin.service', [])
    ...
    .factory('laptopServices', laptopServices)
    .factory('hitungServices', hitungServices)
    ;
...
function laptopServices($http, $q, helperServices, AuthService, pesan) {
    var controller = helperServices.url + 'laptop/';
    var service = {};
    service.data = [];
    return {
        get: get,
    ...
    function put(param) {
        ...
        $http({
            ...
            (res) => {
                def.resolve(res.data);
                var item = service.data.find(x=>x.id == res.data.id);
                if(item){
                    item.merk = res.data.merk;
                    item.jenis = res.data.jenis;
...
function hitungServices($http, $q, helperServices, AuthService, pesan) {
